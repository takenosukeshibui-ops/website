        ...
        <main className="min-h-screen bg-slate-50 p-4 md:p-8 text-xs space-y-4 max-w-5xl mx-auto">
            ...
            <div className="flex items-center justify-between pb-2 border-b border-slate-200">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Link href="/inventory" target="_blank" className="bg-purple-600 hover:bg-purple-700 text-white font-bold px-3 py-1.5 rounded transition-colors">
                        ↗ ユーザー公開用在庫表示を確認
                    </Link>
                </div>
            </div>
