    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-slate-50">
            <form action={action} className="w-full max-w-sm rounded-lg bg-white p-8 border border-slate-200 shadow-sm">
                ...
                <input name="password" type="password" placeholder="パスワード" required className="mb-2 w-full rounded p-2 border border-slate-300 bg-white text-slate-900 placeholder:text-slate-400 focus:ring-1 focus:ring-slate-500 outline-none" />
                
                {/* ★ パスワードを忘れた方用のリンク */}
                <div className="text-right mb-6">
                    <Link href="/forgot-password" className="text-xs text-slate-500 hover:text-slate-800 hover:underline">
                        パスワードをお忘れですか？
                    </Link>
                </div>
