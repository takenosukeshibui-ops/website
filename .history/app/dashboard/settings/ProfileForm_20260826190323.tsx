                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('full_name') || '例: 山田 太郎'} 
                                required 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('company_name') || '例: 株式会社サンプル'} 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('phone') || '例: 090-1234-5678'} 
                                required 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('tax_id') || '例: T1234567890123'} 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                    </div>
                        ...
                        <div className="p-4 rounded border border-slate-200 bg-slate-50 flex flex-col justify-between gap-3">
                            <div>
                                ...
                                <input 
                                    ...
                                    placeholder={profile?.wise_email || 'wise@example.com'} 
                                    className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none bg-white mb-2 placeholder:text-slate-400" 
                                />
                                <p className="text-[11px] text-slate-500">
                                    報酬や返金の受取に使用するWise登録メールアドレスを入力してください。
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('country') || '例: Japan'} 
                                required 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('zip_code') || '例: 100-0001'} 
                                required 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('state_province') || '例: 東京都 (ない場合は空欄)'} 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('city') || '例: 千代田区'} 
                                required 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                    ...
                    <div className="flex flex-col gap-3 mb-4">
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('address_line1') || '例: 千代田1-1-1'} 
                                required 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('address_line2') || '例: サンプルビル 2F'} 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={getValue('address_line3') || ''} 
                                className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none placeholder:text-slate-400" 
                            />
                        </div>
                    </div>
