                        ...
                        <div className="p-4 rounded border border-slate-200 bg-slate-50 flex flex-col justify-between gap-3">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full p-2 border border-slate-300 rounded text-slate-900 text-sm focus:ring-1 focus:ring-blue-500 outline-none bg-white" 
                                />
                            </div>
                        </div>
                    </div>
...
export default function ProfileForm({ profile, userEmail }: { profile: any, userEmail: string }) {
    ...
    const handleWiseTestPayout = async () => {
        ...
        if (!targetEmail) {
            alert('Wise用メールアドレスを入力して「保存」してからテストを実行してください。')
            return
        }
                        ...
                        <div className="p-4 rounded border border-slate-200 bg-slate-50 flex flex-col justify-between gap-3">
                            ...
                            <div className="pt-2 border-t border-slate-200">
                                <button
                                    ...
                                    disabled={isTestingWise || !getValue('wise_email')}
