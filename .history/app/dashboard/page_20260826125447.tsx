...
export default async function DashboardPage(props: {
    ...
    return (
        <div className="container mx-auto p-4 max-w-5xl">
            ...
            {/* 商品追加フォーム (addToCart アクションで即時キャッシュ更新) */}
            <form action={addToCart} className="my-6 p-4 bg-white rounded-lg border border-slate-200 shadow-sm flex flex-col md:flex-row gap-3 items-center">
