...
function AdminNoteForm({ 
    ...
    // 送信済みで、かつ「修正」モードでない場合はテキストだけを表示
    if (isNoteSent && !isEditing) {
        return (
            <div className="flex flex-col gap-1.5">
                ...
                <button 
                    ...
                    className="text-[10px] text-slate-500 hover:text-slate-800 self-start underline transition-colors"
                >
                    メッセージを修正する
                </button>
            </div>
