...
function WiseInvoiceLinkButton({ order }: { order: any }) {
    ...
    const handleOpenWise = () => {
        ...
        // 法人アカウント用の pay/business/ URL構造を使用
        const wiseUrl = `https://wise.com/pay/business/${wiseHandle}?${params.toString()}`
