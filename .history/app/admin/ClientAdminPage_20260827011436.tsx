                                    ...
                                    <td className="border border-slate-300 p-2 text-center whitespace-nowrap">
                                        {isPaymentRequired || isShipped ? (
                                            ...
                                            <button
                                                ...
                                                className={`px-3 py-1.5 rounded text-xs font-bold shadow-sm transition-colors whitespace-nowrap text-white ${hasInvoice ? 'bg-slate-700 hover:bg-slate-800' : 'bg-slate-300 cursor-not-allowed opacity-70'
                                                    }`}
                                            >
                                                送信 (Wise) ↗
                                            </button>
                                    ...
                                    <td className="border border-slate-300 p-2 text-center whitespace-nowrap">
                                        {isShipped ? (
                                            ...
                                            <button
                                                ...
                                                className={`px-3 py-1.5 text-white rounded text-xs font-bold shadow-sm transition-colors ${isPaymentRequired && hasTracking
                                                        ? 'bg-blue-600 hover:bg-blue-700'
