...
function WiseInvoiceLinkButton({ order }: { order: any }) {
    ...
    const handleOpenWise = () => {
        ...
        // クリップボードにコピーする情報のテキスト
        const copyText = `金額: ${amount} JPY\n注文番号: #${order.order_number ?? ''}\n顧客Wiseメール: ${wiseEmail || '未登録'}`
        ...
        // Wiseの支払いリクエスト作成ページ（別タブ）
        window.open('https://wise.com/balances/request', '_blank')
    }
