            ...
            <table className="min-w-full border-collapse border border-slate-300 text-sm text-left bg-white shadow-sm">
                ...
                <tbody>
                    {orders?.map((order) => {
                        ...
                        // この注文内に「要確認(info_required)」の商品が含まれているかチェック
                                                ...
                                                <table className="min-w-full border-collapse text-xs text-left">
                                                    <thead>
                                                        <tr className="border-b border-slate-200 bg-slate-100 text-slate-700">
                                                            ...
                                                            <th className="p-2 font-semibold w-24">備考(サイズ等)</th>
                                                            ...
                                                            {/* ステータスと連絡欄を分離 */}
                                                            <th className="p-2 font-semibold w-32">ステータス</th>
                                                            <th className="p-2 font-semibold min-w-[180px]">連絡欄 (ユーザーへ確認)</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
