                                                ...
                                                <table className="min-w-full border-collapse text-xs text-left">
                                                    <thead>
                                                        <tr className="border-b border-slate-200 bg-slate-100 text-slate-700">
                                                            ...
                                                            <th className="p-2 font-semibold w-32">備考(サイズ等)</th>
                                                            <th className="p-2 font-semibold w-20 text-center">依頼数量</th>
                                                            <th className="p-2 font-semibold w-20 text-center">確定数量</th>
                                                            <th className="p-2 font-semibold w-28 text-right">希望価格</th>
                                                            <th className="p-2 font-semibold w-32 text-right">購入価格(確定)</th>
                                                        ...
                                                        {order.order_items?.map((oi: any, idx: number) => {
                                                            ...
                                                            return (
                                                                <tr key={item.id || idx} className="border-b border-slate-100 hover:bg-slate-50">
                                                                    <td className="p-2 font-medium text-slate-800 max-w-[180px] truncate" title={item.title}>
                                                                        {item.title || '名称未設定'}
                                                                    </td>
                                                                    ...
                                                                    <td className="p-2 text-xs text-slate-600 max-w-[150px] truncate" title={item.remarks}>
                                                                        {item.remarks || '-'}
                                                                    </td>
                                                                    ...
                                                                    <td className="p-2 text-center">
                                                                        <input
                                                                            ...
                                                                            className="border border-slate-300 p-1 rounded text-xs w-14 text-center font-mono font-bold"
                                                                        />
                                                                    </td>
