                                                ...
                                                <table className="min-w-full border-collapse text-xs text-left">
                                                    <thead>
                                                        <tr className="border-b border-slate-200 bg-slate-100 text-slate-700">
                                                            ...
                                                            <th className="p-2 font-semibold w-28">備考(サイズ等)</th>
                                                            <th className="p-2 font-semibold w-16 text-center">依頼数量</th>
                                                            <th className="p-2 font-semibold w-16 text-center">確定数量</th>
                                                            <th className="p-2 font-semibold w-24 text-right">希望価格</th>
                                                            <th className="p-2 font-semibold w-28 text-right">購入価格(確定)</th>
                                                            <th className="p-2 font-semibold min-w-[200px]">ステータス / 連絡欄</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {order.order_items?.map((oi: any, idx: number) => {
                                                            ...
                                                            return (
                                                                <tr key={item.id || idx} className="border-b border-slate-100 hover:bg-slate-50">
                                                                    <td className="p-2 font-medium text-slate-800 max-w-[150px] truncate" title={item.title}>
                                                                        {item.title || '名称未設定'}
                                                                    </td>
                                                                    ...
                                                                    <td className="p-2 text-xs text-slate-600 max-w-[120px] truncate" title={item.remarks}>
                                                                        {item.remarks || '-'}
                                                                    </td>
                                                                        ...
                                                                        <div className="flex flex-col gap-1.5">
                                                                            ...
                                                                            <form action={async (formData) => {
                                                                                ...
                                                                                <input 
                                                                                    ...
                                                                                    className="w-full p-1 border border-slate-300 rounded text-[10px]" 
                                                                                />
                                                                                <button type="submit" className="px-2 py-1 bg-red-600 hover:bg-red-700 text-white font-bold rounded text-[10px] whitespace-nowrap">
                                                                                    要確認送信
                                                                                </button>
                                                                            </form>
                                                                        </div>
